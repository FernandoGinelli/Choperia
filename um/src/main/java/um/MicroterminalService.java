...
public class MicroterminalService {
        ...
        public String api(String numero) {

        HttpClient httpClient = HttpClients.createDefault();
        HttpGet httpGet = new HttpGet("http://localhost:3002/api/cartao/"+ numero);
        ...
        private void verificarContaCliente(String codigoCartaoCliente, DataOutputStream dos) throws IOException {
            ...
            searchProduct = true;
            try {
                String content = api(codigoCartaoCliente);
                dos.flush();
